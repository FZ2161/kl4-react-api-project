...
export default function BreweryCard({ brewery, isFavorite, toggleFavorite, onSelect }) {
  return (
    <div className="brevery-card bg-white p-4 rounded shadow hover:shadow-md transition">
      ...
      <div className="mt-3 flex items-center space-x-2">
        <button onClick={() => onSelect(brewery)} className="px-3 py-1 bg-gray-100 rounded">Details</button>
